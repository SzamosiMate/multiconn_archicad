...
def main():
    ...
    try:
        ...
        print(f"❌ ERROR: {official_paths.CLEANED_PYDANTIC_MODELS} not found. Please run the cleaner script first.")
        return
    ...
    print(f"✅ Successfully wrote {len(base_model_blocks)} definitions to {official_paths.FINAL_PYDANTIC_TYPES}")
    ...
    print(f"✅ Successfully wrote {len(command_model_blocks)} definitions to {official_paths.FINAL_PYDANTIC_COMMANDS}")
