...
EnumValueIds: TypeAlias = list[EnumValueId1]
"""
...
TypeOfElementOrError: TypeAlias = TypeOfElementOrError1 | ErrorItem
...
ImageOrError: TypeAlias = ImageOrError1 | ErrorItem
...
BoundingBox2DOrError: TypeAlias = BoundingBox2DOrError1 | ErrorItem
...
BoundingBox3DOrError: TypeAlias = BoundingBox3DOrError1 | ErrorItem
...
AttributeFolderOrError: TypeAlias = AttributeFolderOrError1 | ErrorItem
...
LayerAttributeOrError: TypeAlias = LayerAttributeOrError1 | ErrorItem
...
FillAttributeOrError: TypeAlias = FillAttributeOrError1 | ErrorItem
...
SurfaceAttributeOrError: TypeAlias = SurfaceAttributeOrError1 | ErrorItem
...
ProfileAttributeOrError: TypeAlias = ProfileAttributeOrError1 | ErrorItem
...
CompositeAttributeOrError: TypeAlias = CompositeAttributeOrError1 | ErrorItem
...
DashOrLineItem: TypeAlias = DashOrLineItem1 | DashOrLineItem2
...
LineAttributeOrError: TypeAlias = LineAttributeOrError1 | ErrorItem
...
ZoneCategoryAttributeOrError: TypeAlias = ZoneCategoryAttributeOrError1 | ErrorItem
...
BuildingMaterialAttributeOrError: TypeAlias = (
    BuildingMaterialAttributeOrError1 | ErrorItem
)
...
LayerCombinationAttributeOrError: TypeAlias = (
    LayerCombinationAttributeOrError1 | ErrorItem
)
...
ClassificationIdOrError: TypeAlias = ClassificationIdOrError1 | ErrorItem
...
ElementClassificationOrError: TypeAlias = ElementClassificationOrError1 | ErrorItem
...
ClassificationItemOrError: TypeAlias = ClassificationItemOrError1 | ErrorItem
...
ClassificationSystemOrError: TypeAlias = ClassificationSystemOrError1 | ErrorItem
...
NavigatorItemIds: TypeAlias = list[NavigatorItemId1]
"""
...
NavigatorItemIdAndTypeOrError: TypeAlias = NavigatorItemIdAndTypeOrError1 | ErrorItem
...
DetailNavigatorItemOrError: TypeAlias = DetailNavigatorItemOrError1 | ErrorItem
...
Document3DNavigatorItemOrError: TypeAlias = Document3DNavigatorItemOrError1 | ErrorItem
...
ElevationNavigatorItemOrError: TypeAlias = ElevationNavigatorItemOrError1 | ErrorItem
...
SectionNavigatorItemOrError: TypeAlias = SectionNavigatorItemOrError1 | ErrorItem
...
StoryNavigatorItemOrError: TypeAlias = StoryNavigatorItemOrError1 | ErrorItem
...
WorksheetNavigatorItemOrError: TypeAlias = WorksheetNavigatorItemOrError1 | ErrorItem
...
BuiltInContainerNavigatorItemOrError: TypeAlias = (
    BuiltInContainerNavigatorItemOrError1 | ErrorItem
)
...
PropertyGroupOrError: TypeAlias = PropertyGroupOrError1 | ErrorItem
...
PropertyValueOrErrorItem: TypeAlias = PropertyValueOrErrorItem1 | ErrorItem
...
PropertyValuesOrError: TypeAlias = PropertyValuesOrError1 | ErrorItem
...
PropertyIdsOfElementOrError: TypeAlias = PropertyIdsOfElementOrError1 | ErrorItem
...
PenTableAttributeOrError: TypeAlias = PenTableAttributeOrError1 | ErrorItem
...
PropertyDefinitionOrError: TypeAlias = PropertyDefinitionOrError1 | ErrorItem
