...
#   timestamp: 2025-06-26T15:24:44+00:00
...
class GetClassificationsOfElementsResult(TypedDict):
    elementClassifications: List[ElementClassificationOrError1 | ErrorItem]
...
class GetPropertyValuesOfElementsResult(TypedDict):
    propertyValuesForElements: List[PropertyValuesOrError1 | ErrorItem]
...
class GetPropertyValuesOfAttributesResult(TypedDict):
    propertyValuesForAttributes: List[PropertyValuesOrError1 | ErrorItem]
...
class CreatePropertyDefinitionsResult(TypedDict):
    propertyIds: List[PropertyIdOrError1 | ErrorItem]
