...
#   timestamp: 2025-07-11T20:38:37+00:00
...
class GetAddOnVersionResult(RootModel[constr(min_length=1)]):
    root: constr(min_length=1) = Field(
        ..., description='Version number in the form of "1.1.1".'
    )


class GetArchicadLocationResult(RootModel[constr(min_length=1)]):
    root: constr(min_length=1) = Field(
...
class GenerateDocumentationParameters(RootModel[constr(min_length=1)]):
    root: constr(min_length=1) = Field(
