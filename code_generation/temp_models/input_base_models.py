...
#   timestamp: 2025-06-26T15:24:43+00:00
...
class PropertyValuesOrError1(BaseModel):
    ...
    propertyValues: List[PropertyValueOrErrorItem1 | ErrorItem] = Field(
        ..., description="A list of property values."
    )


class PropertyIdOrError1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    propertyId: PropertyId
...
class ElementClassificationOrError1(BaseModel):
    ...
    classificationIds: List[ClassificationIdOrError1 | ErrorItem] = Field(
...
class DocumentRevision1(BaseModel):
    revisionId: DocumentRevisionId
    id: str
    finalId: str
    ownerUser: str
...
class RevisionChangesOfEntities1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class GetCurrentWindowTypeResult(BaseModel):
    ...
    currentWindowType: Literal[
        ...
        "Unknown",
    ] = Field(..., description="The type of a window.")
...
class SetStoriesParameters(BaseModel):
    ...
    stories: List[Story1] = Field(..., description="A list of project stories.")
...
class TypeSpecificDetails1(BaseModel):
...
class Details(BaseModel):
    ...
    typeSpecificDetails: TypeSpecificDetails1 | None = None
...
class Get3DBoundingBoxesResult(BaseModel):
    ...
    boundingBoxes3D: List[BoundingBox3DOrError1 | ErrorItem] = Field(
...
class GetClassificationsOfElementsResult(BaseModel):
    ...
    elementClassifications: List[ElementClassificationOrError1 | ErrorItem] = Field(
        ...,
...
class SlabsDatum(BaseModel):
    ...
    holes: List[Hole1] | None = Field(None, description="Array of parameters of holes.")
...
class MeshesDatum(BaseModel):
    ...
    skirtType: (
        Literal["SurfaceOnlyWithoutSkirt", "WithSkirt", "SolidBodyWithSkirt"] | None
    ) = Field(None, description="The type of the skirt structure.")
...
class GetPropertyValuesOfElementsResult(BaseModel):
    ...
    propertyValuesForElements: List[PropertyValuesOrError1 | ErrorItem] = Field(
        ...,
...
class GetPropertyValuesOfAttributesResult(BaseModel):
    ...
    propertyValuesForAttributes: List[PropertyValuesOrError1 | ErrorItem] = Field(
        ...,
...
class PropertyGroup1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str
...
class PropertyGroupId1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class CreatePropertyGroupsResult(BaseModel):
    ...
    propertyGroupIds: List[PropertyGroupId1] = Field(
...
class CreatePropertyDefinitionsResult(BaseModel):
    ...
    propertyIds: List[PropertyIdOrError1 | ErrorItem] = Field(
        ..., description="A list of property identifiers."
    )


class PropertyId1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    propertyId: PropertyId
...
class DeletePropertyDefinitionsParameters(BaseModel):
    ...
    propertyIds: List[PropertyId1] = Field(
...
class GetAttributesByTypeParameters(BaseModel):
    ...
    attributeType: Literal[
        ...
        "OperationProfile",
        "BuildingMaterial",
    ] = Field(..., description="The type of an attribute.")
...
class AddCommentToIssueParameters(BaseModel):
    ...
    status: Literal["Error", "Warning", "Info", "Unknown"] | None = Field(
        None, description="The status of an issue comment."
    )
...
class Comment(BaseModel):
    ...
    status: Literal["Error", "Warning", "Info", "Unknown"] = Field(
...
class GetElementsAttachedToIssueParameters(BaseModel):
    ...
    issueId: IssueId
    type: Literal["Creation", "Highlight", "Deletion", "Modification"] = Field(
...
class GetCurrentRevisionChangesOfLayoutsResult(BaseModel):
    ...
    currentRevisionChangesOfLayouts: RevisionChangesOfEntities1 | ErrorItem
...
class GetRevisionChangesOfElementsResult(BaseModel):
    ...
    revisionChangesOfElements: RevisionChangesOfEntities1 | ErrorItem
...
class DetailsOfElement(BaseModel):
    type: Literal[
        ...
        "Opening",
        "Unknown",
    ] = Field(..., description="The type of an element.")
    id: str
    floorIndex: float
    layerIndex: float
    drawIndex: float
...
class PropertyDefinition1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str
