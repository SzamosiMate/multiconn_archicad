...
# --- Configuration ---
GENERATED_INPUT_FILE = Path("../temp_models/base_models.py")

# The final, separated output files
BASE_MODELS_OUTPUT = Path("../temp_models/base_models.py")
COMMAND_MODELS_OUTPUT = Path("../temp_models/command_models.py")
