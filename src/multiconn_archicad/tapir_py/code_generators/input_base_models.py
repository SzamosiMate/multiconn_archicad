...
class ElementFilter(
    ...
    root: Literal[
        ...
        "HasAccessRight",
        "IsOverriddenByRenovation",
    ] = Field(..., description="A filter type for an element.")
...
class IssueElementType(
    RootModel[Literal["Creation", "Highlight", "Deletion", "Modification"]]
):
    root: Literal["Creation", "Highlight", "Deletion", "Modification"] = Field(
        ..., description="The attachment type of an element component of an issue."
    )


class IssueCommentStatus(RootModel[Literal["Error", "Warning", "Info", "Unknown"]]):
    root: Literal["Error", "Warning", "Info", "Unknown"] = Field(
...
class PropertyValuesOrErrorArray(RootModel[List[PropertyValuesOrError1 | ErrorItem]]):
    root: List[PropertyValuesOrError1 | ErrorItem] = Field(
...
class PropertyIdOrErrorArray(RootModel[List[PropertyIdOrError1 | ErrorItem]]):
    root: List[PropertyIdOrError1 | ErrorItem] = Field(
        ..., description="A list of property identifiers."
    )
...
class ElementClassificationsOrErrors(
    RootModel[List[ElementClassificationOrError1 | ErrorItem]]
):
    root: List[ElementClassificationOrError1 | ErrorItem] = Field(
        ..., description="A list of element classification identifiers or errors."
    )
...
class BoundingBoxes3D(RootModel[List[BoundingBox3DOrError1 | ErrorItem]]):
    root: List[BoundingBox3DOrError1 | ErrorItem] = Field(
...
class ViewSettingsOrError(RootModel[ViewSettings | ErrorItem]):
    root: ViewSettings | ErrorItem
...
class ViewTransformationsOrError(RootModel[ViewTransformations | ErrorItem]):
    root: ViewTransformations | ErrorItem
...
class RevisionChangesOfEntities(RootModel[RevisionChangesOfEntities1 | ErrorItem]):
    root: RevisionChangesOfEntities1 | ErrorItem
...
class PropertyDefaultValue(RootModel[BasicDefaultValue | ExpressionDefaultValue]):
    root: BasicDefaultValue | ExpressionDefaultValue
