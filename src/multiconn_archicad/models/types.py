...
class CurtainWallPanelDetails(BaseModel):
    ...
    polygonCoordinates: List[Field3DCoordinate] = Field(
...
class CurtainWallSegmentDetails(BaseModel):
    ...
    arcOrigin: Field3DCoordinate | None = None
...
class Details(BaseModel):
    ...
    typeSpecificDetails: TypeSpecificDetails | None = None
...
class MeshesDatum(BaseModel):
    ...
    skirtType: SkirtType | None = Field(
        None, description="The type of the skirt structure."
    )
    ...
    holes: List[Hole4] | None = Field(None, description="Array of parameters of holes.")
...
class PolylinesDatum(BaseModel):
    ...
    coordinates: List[Field2DCoordinate] = Field(
...
class TypeSpecificDetails(BaseModel):
    begCoordinate: Field2DCoordinate | None = None
    endCoordinate: Field2DCoordinate | None = None
